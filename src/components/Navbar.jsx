...
export default function Navbar(){
   const [menuOpen, setMenuOpen] = useState(false);
    ...
    return(
        <nav className="flex flex-col items-start gap-5 font-extralight py-5 px-2 sticky bg-slate-900 text-white w-full top-0 md:flex-row md:justify-between md:items-center md:px-10 ">
